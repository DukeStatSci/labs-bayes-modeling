---
title: "STA 360 Lab 4: Prior selection and model reparameterization"
...
If we set a uniform prior for $\pi$, what is the induced prior on $\theta = \frac{\pi}{(1+\pi)}$? Is this prior proper? Does it result in a proper posterior? If so, under which conditions?
...
The file `jeffreys.stan` runs posterior sampling using the Jeffreys prior. Compare these results to those obtained for other prior specifications.
